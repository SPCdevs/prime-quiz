export default function Page() {
  return (
    <main>
      <h1 className="bg-gradient-to-br from-blue-500 to-indigo-700 bg-clip-text pt-10 text-center text-3xl font-bold text-transparent">
        A Social Media Quiz App!
      </h1>
      <p className="py-3 text-lg sm:px-3 md:px-14 lg:px-24">
      ...
      <div>
        <img
          ...
          alt="placeholder"
          className="mx-auto w-1/4 rounded-3xl"
        />
      </div>
    </main>
  );
